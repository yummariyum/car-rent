...
foreach ($carList as $key) {
	...
	echo "<td>";
	echo "<form method='POST' action="."DeleteCar.php".">";
	echo "<button type='submit' name='cDelete' value=".$objCarEntity->getCarNumberPlate().">Delete</button>";
	echo "</form>";
	echo "</td>";
	echo "</tr>";
	echo "</table>";
