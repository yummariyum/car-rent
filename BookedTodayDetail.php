...
<div class="container">
    <h1>Today Booked Information</h1>
        ...
        include ("BookedDAL.php");
            ...
            $resultSet=$objBookedDAL->todayBookedTrip();
        ...
        echo "<div>" ;
        echo "Customer Name:";
        echo "<label>".$key["csName"]."</label>";
        echo "<br>";
        echo "<br>";
        
        
        echo "Customer PhoneNo:";
        echo "<label>".$key["csPhone"]."</label>";
        echo "<br>";
        echo "<br>";
        
        
        echo "Customer CNIC No:";
        echo "<label>".$key["csCNIC"]."</label>";
        echo "<br>";
        echo "<br>";
